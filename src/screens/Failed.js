      ...
      <View style={styles.container}>
        ...
        <View style={styles.footer}>
          <ScrollView style={styles.footerContent}>
            ...
            <Text style={styles.titleFooter}>Transfer Failed</Text>
            <Text style={styles.description}>We can’t transfer your money at the moment, we recommend you to check your internet connection and try again.</Text>
            ...
            <View style={styles.buttonWrapper}>
              <TouchableOpacity  style={false ? styles.buttonBlank : styles.buttonFilled}>
                <Text style={false ? styles.textButtonBlank : styles.textButtonFilled}>Try Again</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        </View>
