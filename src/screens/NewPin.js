        ...
        <View style={styles.container}>
          ...
          <View style={styles.footer}>
            <View style={styles.footerContent}>
              <Text style={styles.textFooter}>Type your new 6 digits security PIN to use in Zwallet.</Text>
              <TextInput
              ...
              <View style={styles.buttonWrapper}>
                <TouchableOpacity disabled={interval.length !== 6} style={interval.length !== 6 ? styles.buttonBlank : styles.buttonFilled}>
                  <Text style={interval.length !== 6 ? styles.textButtonBlank : styles.textButtonFilled}>Change PIN</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
